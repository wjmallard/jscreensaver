...
- **Default `delay` 40000 µs** vs the xml's 30000, a touch calmer per the project's tuning preference (noted as live-tunable). `ncolors` clamps to >= 2 like the C.
